...
import CarSedan from "../images/cars/sedan.jpg";
import CarVan from "../images/cars/van.jpg";
import CarSuv from "../images/cars/suv.jpg";
              ...
              <form className="box-form">
                ...
                <div className="box-form__car-time">
                  ...
                  <input
                    ...
                    disabled={pickTime === "" ? true: false}
                    min={pickTime ? new Date(pickTime).toISOString().split("T")[0]: ""}
                    type="date"
                  ></input>
                </div>
        ...
        <div className="booking-modal__person-info">
          ...
          <form className="info-form">
            ...
            <span className="info-form__checkbox">
              ...
              <p>I agree on all terms and conditions</p>
            </span>
